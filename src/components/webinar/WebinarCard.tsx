...
export default function WebinarCard({ webinar }: { webinar: Webinar }) {
  ...
  return (
    <div className="flex flex-col justify-between rounded-2xl border border-white/10 bg-gradient-to-b from-white/[0.06] to-white/[0.02] p-6 transition-all duration-300 hover:-translate-y-1 hover:border-white/20 hover:shadow-glow sm:p-8">
      <div>
